...
describe('container', () => {
  test('decides from the file content', () => {
  ...
  test('mime guess — m4a when unknown (opens everywhere)', () => {
  ...
  test('content wins over mime — the name is right even when mimeType is empty or wrong', () => {
