...
export const CFG = {
  ...
  // 40~200 (v2.3.2 M7): 기계식 멜첼 표준이 40~208 이고 208 은 그 눈금 체계(40~60 은 2씩 … 144~208 은 8씩)의 마지막 칸일 뿐
  // 음악적 의미가 없다. 40 미만·200 초과는 실사용에서 거의 안 쓴다는 사용자 판단. 좁히면 270° 호에 160 BPM →
  // 1.69°/BPM 으로 회전 정밀도가 25 % 오르고, 눈금(5 마다 33)·숫자(20 마다 9: 40·60·…·200)도 덜 빽빽해진다.
