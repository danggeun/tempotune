 ...
 */
describe('the mic audio session is declared before getUserMedia', () => {
  ...
  test('openMic calls audioSessionHint(true) before getUserMedia', () => {
  ...
  test('a failed open goes back to playback-only', () => {
  ...
  test('closeMic goes back to playback-only', () => {
  ...
  test('the session type depends only on whether the mic is on', () => {
