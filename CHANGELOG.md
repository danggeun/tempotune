...
- New app icon — a violin bridge with its heart and curled kidneys, standing on a mahogany tile under three strings, with beat marks on both sides. Drawn crisp at each home-screen size; Android 13+ themed icons follow the wallpaper color, and the browser tab shows the bridge on a rounded tile
