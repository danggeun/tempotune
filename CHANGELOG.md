...
- **브랜드**: 로고 공모 — 후보 14안 → 3인 독립 심사 → 하이브리드 6안 재심사 → 띠 형태 6안 → 최종 'Go' + 초록 게이지(허용 띠 + 흰 바늘, 검정 #0d0d0e). 잉크 실측 기반 락업(띠 = 글자 폭 75 %, 바늘 2.6 % + 돌출), adaptive/maskable/테마 아이콘 레이어, 앱 이름 "Go practice"
