...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    VitePWA({
      ...
      // autoUpdate 는 실행 중인 페이지의 지연 청크(워클릿/워커)를 캐시에서 지워 첫 실행에 오디오가 죽는다
      registerType: 'prompt',
      injectRegister: null,
      ...
      manifest: {
        ...
        display: 'standalone', orientation: 'portrait', background_color: '#732812', theme_color: '#eef0f3', lang: 'ko',
